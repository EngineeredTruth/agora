...
1 verbose cli   'run',
1 verbose cli   'examples' ]
2 info using npm@3.10.3
3 info using node@v6.3.0
4 verbose stack Error: missing script: examples
...
5 verbose cwd /Users/Tran/Desktop/DevMountain/agora/node_modules
6 error Darwin 15.6.0
7 error argv "/usr/local/Cellar/node/6.3.0/bin/node" "/usr/local/bin/npm" "run" "examples"
8 error node v6.3.0
9 error npm  v3.10.3
10 error missing script: examples
